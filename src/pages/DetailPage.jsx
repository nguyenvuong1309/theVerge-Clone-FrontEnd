...
const DetailPage = () => {
    ...
    return (
        <>
            <div
                //className={`App ${window.location.pathname.substring(1)} grid justify-center caret-transparent mt-[278px]`}
                className={` App grid justify-center caret-transparent mt-[278px] ${theme === 'light' ? ' bg-black text-white ' : ' bg-white text-black '}`}
            // style={{ background: `var(--default-background)`, color: `var(--default-text)` }}
            >
                <div className="w-full grid justify-center max-w-[1100px]">
                    <div className="w-[100%]">
                        ...
                        <div className='flex justify-start max-[1200px]:justify-center mb-[26px]'>
                    ...
                    <div className='w-[300px] max-[1200px]:hidden'>
                        <div className='pt-[400px]'>
                            <div className="w-[300px] h-[441.88px] relative bg-white rounded">
                                ...
                                <div className="w-[260px] h-[381.88px] left-[20px] top-[20px]  ">
                                    ...
                                    <div className="pl-7 pr-[18.10px] pb-[22.20px] left-0 top-[80.38px]   justify-end items-center inline-flex">
                                    ...
                                    <div className="w-[160.20px] h-[19px] left-[28px] top-[241.13px]   text-black text-base font-bold font-['Arial'] leading-tight tracking-tight">They’re ‘skeets’ now</div>
                                    <div className="pl-7 pr-[4.14px] pb-[22.18px] left-0 top-[302.31px]   justify-end items-center inline-flex">
            ...
            <div className='flex justify-center mt-20 w-full bg-[#3CFFD0]'>
                <div className="">
                    <div className=''>
            ...
            <div className='flex justify-center mt-[80px] '>
                <div class="w-[95%]   border-b border-gray-200">
                    <div class="w-[223.41px] h-[29.79px] left-[-2.30px] top-[6px]   border-r-2 border-t-2 border-neutral-700"></div>
                    <div class="left-[13px] top-[13px]   text-neutral-700 text-[25px] font-bold font-['Arial'] leading-[25px]">RECOMMENDED</div>

                    <div class="w-full  left-0   flex flex-wrap gap-16 mt-20">
                        <div className='grid'>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">If you own a mouse, you have<br />to play this game. No Install.<br />Play for free.</div>
                            </div>

                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | Panzer.Quest strategy game</div>
                            </div>
                        </div>
                        ...
                        <div className='grid'>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">[Gallery] 17 Movies That Ended<br />Actors' Careers</div>
                            </div>
                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | HeraldWeekly</div>
                            </div>
                        </div>

                        <div>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">[Gallery] 35 Bad Tattoo<br />Decisions That Will Have You<br />Laughing Out Loud</div>
                            </div>
                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | HeraldWeekly</div>
                            </div>
                        ...
                        <div>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">Discover the Most Expensive<br />Homes in Los Angeles</div>
                            </div>
                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | Mansion Global</div>
                            </div>
                        </div>

                        <div>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">These Are Things That Are<br />Normal In Japan But You Won't<br />See Anywhere Else</div>
                            </div>
                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | Investing Magazine</div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="">
                                <div class="text-neutral-700 text-[15px] font-bold font-['Arial'] leading-[18.75px]">Why are houses in Dubai so<br />cheap? (Just look)</div>
                            </div>
                            <div class="">
                                <div class="text-neutral-500 text-xs font-bold font-['Arial'] leading-[18px]">Sponsored | Dubai Apartments |<br />Sponsored</div>
                            </div>
                        </div>
                    </div>
                </div>
