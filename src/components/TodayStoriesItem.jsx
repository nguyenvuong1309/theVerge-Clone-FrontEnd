...
const TodayStoriesItem = ({ logo, border, author, time, content, summary, origin }) => {
    const navigate = useNavigate();
    return (
        <div className={`max-w-[500px] pt-[24px] pr-[10px] pb-[25px] pl-[7px]  hover:bg-slate-100 hover:bg-opacity-5 flex ${border ? ` border border-[#313131CC] border-b-1 border-x-0 border-t-0 ` : ' '} text-white`} onClick={() => navigate("/detailpage")}>
            ...
            <div className="w-full">
                ...
                <div className="w-full">
                    <span className="text-zinc-100 text-base font-normal font-['Georgia'] leading-[23px]">
