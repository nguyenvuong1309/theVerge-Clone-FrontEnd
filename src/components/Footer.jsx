...
const Footer = () => {
    return (
        <div className="w-[1100px] h-[215px]">
            <div className="h-[90.16px] flex justify-start items-start">
                <svg width="397" height="89" viewBox="0 0 397 89" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="pt-[29.98px] h-[95px] flex gap-5">
                <div className="">
                    <div className="text-white text-[11px] font-normal font-['Helvetica'] uppercase leading-[21px] tracking-wider grid w-[733px]">
                    ...
                    <div className="text-white text-[11px] font-normal font-['Helvetica'] uppercase leading-[21px] tracking-wider w-[733px] pt-[16px] flex gap-2">
                ...
                <div className="w-[366.66px] h-[95px] relative flex-col justify-start items-start inline-flex">
                    <div className="text-white text-[11px] font-bold font-['Helvetica'] uppercase leading-[21px] tracking-wider">The Verge is a vox media network</div>
                    <div className="pr-[76.47px] justify-start items-start gap-[12.31px] inline-flex">
                        <div className="text-white text-[11px] font-normal font-['Helvetica'] uppercase leading-tight tracking-wider hover:underline hover:underline-offset-2">Advertise with us</div>
                        <div className="pr-[6.39px] justify-start items-start gap-[10.49px] flex">
                            ...
                            <div className="text-white text-[11px] font-normal font-['Helvetica'] uppercase leading-tight tracking-wider hover:underline hover:underline-offset-2">Jobs @ Vox Media</div>
                        </div>
                    </div>
                    <div className="pr-[20.57px] pb-px justify-start items-start gap-[6.09px] inline-flex">
                        <div className="text-white text-xs font-normal font-['Georgia'] uppercase leading-[21px] tracking-wider">© 2023</div>
                        <div><span className="text-white text-xs font-normal font-['Georgia'] uppercase leading-[21px] tracking-wider">Vox Media</span><span className="text-white text-xs font-normal font-['Georgia'] uppercase leading-[21px] tracking-wider">, LLC. All Rights Reserved</span></div>
                    </div>
                </div>
            </div>
